...
import com.rotai.coolweather.gson.Forecast;
import com.rotai.coolweather.gson.Weather;
import com.rotai.coolweather.service.AutoUpdateService;
...
public class WeatherActivity extends AppCompatActivity {
    ...
    void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=178700a535b94650bc13bb814f81d068";
